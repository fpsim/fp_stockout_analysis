...
def make_pars():
    ...
    pars['prob_use_trend_par'] = 0.01  # Time trend in contraceptive use - adjust this to get steeper/slower trend
    pars['prob_use_intercept'] = -1.2  # Intercept for the probability of using contraception - shifts the mCPR level
